...
client.on('interactionCreate', async (interaction) => {
    ...
    if (commandName === 'welcome-config') {
        ...
        updateWelcomeConfig(guild.id, 'channelId', channelId);
    ...
    if (commandName === 'role-config') {
        ...
        updateWelcomeConfig(guild.id, 'roleId', roleId);
    ...
    if (commandName === 'balance') {
        ...
        return interaction.reply(`💰 You have **$${account.balance}**`);
    }
    ...
    if (commandName === 'donate') {
        ...
        if (senderAccount.balance < amount) return interaction.reply('❌ Insufficient balance.');
